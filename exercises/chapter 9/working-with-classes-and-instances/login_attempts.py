...
oriz = User('joseph', 'orisakwe', 'oriz4life', 'oriz4life2022@gmail.com')

print("\nMaking 10 login attempts...")
for _ in range(10):
    oriz.increment_login_attempts()
print(f"  Login attempts: {oriz.login_attempts}")


print("\nResetting login attempts...")
oriz.reset_login_attempts()
print(f"  Login attempts: {oriz.login_attempts}")
