...
class RaindropsGame:
    ...
    def _create_rain(self):
        ...
        new_raindrop_x, new_raindrop_y = raindrop_width, raindrop_height
        while new_raindrop_y <= (self.settings.screen_height - 5 * raindrop_height):
            ...
            new_raindrop_y += 5 * raindrop_height
